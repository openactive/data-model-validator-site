      ...
      <div className="about-page">
        <div className="jumbotron">
          <div className="container">
            ...
            <p><a href="https://www.openactive.io/">OpenActive</a> is a community-led initiative using open data to help people get active. This validator allows you to validate a JSON document against the <a href={specUrl}>Modelling Opportunity Specification{version}</a> and the <a href="https://openactive.io/open-booking-api/EditorsDraft/">Open Booking API Specification v1.0 CR2</a>.</p>
          </div>
        </div>
        <div className="container">
          <div className="row">
            <div className="col">
              ...
              <ul>
                ...
                <li>Validate properties in schema.org that are not in the <a href={specUrl}>Modelling Opportunity Specification{version}</a> or the <a href="https://openactive.io/open-booking-api/EditorsDraft/">Open Booking API Specification v1.0 CR2</a>.</li>
              </ul>
            </div>
          </div>
          <div className="row">

      ...
      <div className="about-page">
        <div className="jumbotron">
          <div className="container">
            ...
            <p><a href="https://www.openactive.io/">OpenActive</a> is a community-led initiative using open data to help people get active. This validator allows you to validate a JSON document against the <a href={specUrl}>Modelling Opportunity Specification{version}</a>.</p>
          </div>
        </div>
        <div className="container">
          <div className="row">
            <div className="col">
              ...
              <ul>
                ...
                <li>Validate properties in schema.org that are not in the <a href={specUrl}>Modelling Opportunity Specification{version}</a>.</li>
              </ul>
            </div>
          </div>
          <div className="row">

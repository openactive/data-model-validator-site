      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col text-right">
            Validating <a title="Modelling Opportunity Data Specification" aria-label="Modelling Opportunity Data Specification" href={url}>Model {version}</a> and <a title="Open Booking API Specification" aria-label="Open Booking API Specification" href="https://www.openactive.io/open-booking-api/EditorsDraft/">Booking v1.0 CR2</a>

  ...
  render() {
    return (
      <div className="information-row text-center hero-sub">
        <p>
          This tool allows you to validate your data models against the <a href={consts.MODELLING_SPECIFICATION_URL} target="_blank" rel="noopener">Modelling Opportunity Data Specification v{consts.MODELLING_SPECIFICATION_VERSION} <FontAwesomeIcon icon="external-link-alt" /></a>.
        </p>
        <p>
